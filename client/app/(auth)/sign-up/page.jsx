...
import { Button, Container, Flex, Radio, Text, TextField } from '@radix-ui/themes';
...
export default function SignupPage() {
	...
	const validationSchema = yup.object({
		...
		password: yup.string().required("Password is  required!").min(8, "Password must be at least 8 characters long")
			...
			.matches(/[0-9]/, "Pa contssword must contain at least one number")
						...
						<form onSubmit={handleSubmit} method='POST'>
							<Flex gap="3" direction="column">
								...
								<div className="text-gray-200 my-2">
									Have an account?{' '}
									<Link href="/sign-in" className="font-normal text-white mx-1 underline">
										Sign In Now
									</Link>
								</div>
